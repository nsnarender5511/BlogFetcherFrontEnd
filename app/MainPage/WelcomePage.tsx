    ...
    return (
        ...
        <Container maxW="7xl" p={4}>
            <Stack direction="column" spacing={6} alignItems="center" mt={8} mb={16}>
                ...
                <HStack spacing={5}>
                    <Button colorScheme="teal" variant="solid" rounded="md" size="lg" onClick={handleLoginClick}>
                        Login
                    </Button>
                    <Button colorScheme="teal" variant="solid" rounded="md" size="lg" onClick={handleSignupClick}>
                        Signup
                    </Button>
                </HStack>
            </Stack>
